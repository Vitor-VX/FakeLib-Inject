...
#define IMGUI_CHECKVERSION()        ImGui::(IMGUI_VERSION, sizeof(ImGuiIO), sizeof(ImGuiStyle), sizeof(ImVec2), sizeof(ImVec4), sizeof(ImDrawVert), sizeof(ImDrawIdx))
#define IMGUI_HAS_TABLE

// Define attributes of all API symbols declarDebugCheckVersionAndDataLayoutations (e.g. for DLL under Windows)
