//
// Created by saygu on 14/11/2020.
//

#ifndef VIRTUALXPOSED_OBFUSCATE_H
#define VIRTUALXPOSED_OBFUSCATE_H
...
#define OBFUSCATE(data) AY_OBFUSCATE_KEY(data, '.')
...
#endif //VIRTUALXPOSED_OBFUSCATE_H
